...
class NorthwestMethod:
    def __init__(self, a: Matrix, d: Vector, s: Vector):
        ...
        assert a.getHeight() == s.getHeight(), "Length of vector b does not correspond to # of rows of matrix A"
        assert a.getWidth() == d.getWidth(), "Length of vector C does not correspond to # of cols of matrix A"
